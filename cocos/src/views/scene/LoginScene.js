var LoginScene = cc.Scene.extend({
    ...
    onEnter: function () {
        ...
        if(cc.sys.localStorage.getItem("langue") == undefined || cc.sys.localStorage.getItem("langue") == "putonglangue"){
            cc.sys.localStorage.setItem("langue", "putonglangue");
            cc.log("Now putonglangue!");
        }else if(cc.sys.localStorage.getItem("langue") == "wenzhoulangue"){
            cc.sys.localStorage.setItem("langue", "wenzhoulangue");
            cc.log("Now wenzhoulangue!");
        }
    ...
    loadUIManager: function () {
        ...
        // cc.log("测试胡代码:", this.canWin([15, 3,4,7,7,8,9,9,16,17,18,37,37, 5], 5, [15], const_val.OP_DRAW_WIN))
    },

    // canWin:function(handTiles, finalTile, kingTiles, win_op){
    ...
    //     var classifyList = cutil.classifyTiles(copyTiles, kingTiles)
    //     // 财神
    //     var curKingTiles = classifyList[0]
    //     // 白板
    //     var curDragonWhite = classifyList[1]
    //     cc.log(curDragonWhite)
    //     // 非财神
    ...
    //     } if (cutil.canNormalWin(handTilesButKingWhite, kingTiles[0], curKingTiles.length, curDragonWhite.length)) {
    //       canWin = true
    //     }
    //   }
    //   return canWin
